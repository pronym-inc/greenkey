...
ROOT_URLCONF = 'greenkey.conf.urls.main'
...
WSGI_APPLICATION = 'greenkey.conf.wsgi.app.application'
...
# Logging
LOG_PATH = os.path.join(VIRTUALENV_DIR, 'var/log/django/greenkey.log')
...
DEFAULT_FROM_EMAIL = 'admin@greenkey.com'
